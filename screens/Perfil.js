    ...
    <ScrollView style={styles.container}>
      ...
      />
        <TouchableOpacity style={styles.option} onPress={() => {}}>
          ...
          <MaterialIcons name="keyboard-arrow-right" color="#F7559A" size={20} />
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.option}
          onPress={() => navigation.navigate("DetailAnimal")}
        >
          <MaterialCommunityIcons name="clipboard-check-outline" size={35} color="#F7559A" />
          <ScrollView style={styles.info}>
        ...
        <TouchableOpacity style={styles.option} onPress={() => {}}>
          <MaterialCommunityIcons name="heart-outline" size={35} color="#F7559A" />
          <ScrollView style={styles.info}>
        ...
        <TouchableOpacity style={styles.option} onPress={() => {}}>
          <MaterialCommunityIcons name="card-account-details-outline" size={35} color="#F7559A" />
          <ScrollView style={styles.info}>
      ...
      <View style={styles.menuAdicional}>
        <TouchableOpacity style={styles.opcoesAdicionais}>
          <View style={styles.wrapper}>
            <MaterialCommunityIcons name="help-circle" size={25} color="#F7559A" />
        ...
        <TouchableOpacity style={styles.opcoesAdicionais}>
          <View style={styles.wrapper}>
            <MaterialCommunityIcons name="handshake" size={25} color="#F7559A" />
